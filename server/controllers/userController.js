...
const updateWidgetConfig = async (req, res) => {
    try {
        ...
        const allowed = [
            ...
            'botName', 'size', 'autoOpenDelay', 'customCss', 'showPoweredBy', 'allowTalkToHuman', 'noAnswerMessage', 'preChatForm', 'suggestedQuestions', 'leadCaptureWebhookUrl', 'preferredAiModel'
        ];
        const updates = {};
